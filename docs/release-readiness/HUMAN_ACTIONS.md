...
1. [Completed 2026-07-24] The Gmail integration was reconnected as `brasstune1@gmail.com`. Forty-four unique professor drafts were created and verified; none were sent.
...
5. Supabase migrations match through `20260724072904`. Perform disposable live account/export/delete/storage/class/OAuth checks before expanding access.
