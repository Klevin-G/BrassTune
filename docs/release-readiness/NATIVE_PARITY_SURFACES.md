...
- UI smoke coverage for Coach, More, Sessions, Settings, and the Score Practice shell.
...
- Placeholder native shells remain placeholders until their underlying import, metronome, diagnostics, or long-term progress features are implemented and tested.
