...
| App UI tests | Current local post-fix pass on simulator `4B4489C4-295C-4565-9544-30812B4EA0EB` with `1` XCUITest, result bundle `/tmp/BrassTuneAppUISmoke.xcresult`; PR head `d05fe773...` failed before this nested-observable/UI-state fix. |
