...
| App unit tests | Current local post-fix pass on simulator `4B4489C4-295C-4565-9544-30812B4EA0EB` with `3` XCTest cases, result `/Users/aryasalem/Library/Developer/Xcode/DerivedData/BrassTuneApp-hkqputnmioxghnbijdurkpaptmyz/Logs/Test/Test-BrassTuneApp-2026.06.18_21-30-59--0500.xcresult`. |
| App UI tests | Current local post-fix pass on simulator `4B4489C4-295C-4565-9544-30812B4EA0EB` with `1` XCUITest, result bundle `/tmp/BrassTuneAppUISmoke.xcresult`; GitHub Swift passed on PR head `91ca605...` after the nested-observable/UI-state fix. |
