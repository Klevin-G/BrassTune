...
- Imported pages show preview, quality messages, page list, zoom, rotation, remove, and confirm controls.
...
- `cd frontend && npm test` passed: `27` tests.
...
- Perspective correction, crop, retake, page reorder, thumbnails, and fullscreen focus mode.
